...
Button(root, text="=", width=5, height=4, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="#FFA500",command=lambda: calculate()).place(x=430,y=400)
# a qeustion why my bg color is not working (Orange and "#FFA500"
